...
const Notification = ({ type, message, description, txid, onHide }) => {
  ...
  return (
    <div
      className={`max-w-sm w-full bg-bkg-1 shadow-lg rounded-md mt-2 pointer-events-auto ring-1 ring-black ring-opacity-5 p-2 overflow-hidden`}
    >
      <div
        className={`p-4 rounded-md bg-gradient-to-r from-nova from-10% via-purple-600 via-30% to-triton to-90%`}
      >
