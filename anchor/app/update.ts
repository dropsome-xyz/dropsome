...
async function main() {
    ...
    if (!newAuthority) throw new Error("NEW_AUTHORITY not set in environment");
    ...
    const params = {
        authority: new web3.PublicKey(newAuthority),
        isActive: true,
    ...
    try {
        ...
        console.log("App updated. Transaction signature:", tx);
